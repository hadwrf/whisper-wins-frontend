...
export default function BidsFilter({ onApplyFilters }: BidsFilterProps) {
  ...
  const validateFilters = () => {
    ...
    // Date validation
    const bidPlacedFromDate = new Date(filters.bidPlacedFrom);
    const bidPlacedToDate = new Date(filters.bidPlacedTo);
    const endsFromDate = new Date(filters.endsFrom);
    const endsToDate = new Date(filters.endsTo);

    if (filters.bidPlacedFrom && filters.bidPlacedTo && bidPlacedFromDate > bidPlacedToDate) {
      newErrors.bidPlacedDates = "'Bidded From' must be earlier than 'Bidded To'.";
    }
            ...
            <div className='flex w-1/2 flex-col'>
              ...
              <div className='flex w-full flex-col'>
                ...
                >
                  ...
                  <option value='price_desc'>Bid (Descending)</option>
                  <option value='created_at_asc'>Bidded At (Ascending)</option>
                  <option value='created_at_desc'>Bidded At (Descending)</option>
